function Consulta() {
  return (
    <section
      ...
      className="relative min-h-screen px-6 flex items-center justify-center gap-2"
    >
        ...
        <div className="md:w-1/2 space-y-6">
          ...
          <div className="flex gap-6 justify-center md:justify-start mt-6">
            ...
            <a
              ...
              className="w-16 h-16 flex items-center justify-center bg-[#BBA770] rounded-full shadow-lg hover:scale-110 transform transition duration-300"
            >
              <img
